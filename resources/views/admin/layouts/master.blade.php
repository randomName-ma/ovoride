...
<head>
    ...
    <script src="{{ secure_asset('assets/admin/js/theme.js') }}"></script>

    <link rel="stylesheet" href="{{ secure_asset('assets/global/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('assets/global/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('assets/global/css/line-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('assets/global/css/select2.min.css') }}">

    @stack('style-lib')

    <link rel="stylesheet" href="{{ secure_asset('assets/admin/css/main.css') }}">
    @stack('style')
</head>
